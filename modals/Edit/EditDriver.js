                ...
                <form >
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-2">
                            ...
                            <select name="cnh_category" className="form-control" id="status-select" value={formData?.cnh_category} onChange={(e) =>
                                handleInputChange(e)} >
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-2">
                            ...
                            <select name="state" className="form-control" id="status-select" value={formData?.state} onChange={(e) =>
                                handleInputChange(e)} >
                        ...
                        <div className="col-md-3">
                            ...
                            <select name="city" className="form-control" id="status-select" value={formData?.city} onChange={(e) =>
                                handleInputChange(e)} >
